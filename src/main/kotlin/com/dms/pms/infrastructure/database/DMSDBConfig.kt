...
@EnableJpaRepositories(
    ...
    basePackages = ["com.dms.pms.domain.point", "com.dms.pms.domain.stay", "com.dms.pms.domain.student"]
)
class DMSDBConfig {
    ...
    fun localContainerEntityManagerFactoryBean(
        ...
        return builder
            ...
            .packages("com.dms.pms.domain.point", "com.dms.pms.domain.stay", "com.dms.pms.domain.student")
            .persistenceUnit("dms")
            .build()
    }
